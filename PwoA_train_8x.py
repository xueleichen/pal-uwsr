...
from utils.progr_woA_utils import update_model_p3, update_fadein, WeightedSum
# network
...
###################################################################################
# load old model
checkpoint_dir = "/content/drive/My Drive/USR/ablation/checkpoints/p2"
...
model = update_model_p3(generator)
print (model.summary())
