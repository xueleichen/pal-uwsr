...
hr_width, hr_height = 320, 240 # high res
# input and output data
lr_shape = (lr_height, lr_width, channels)
hr_shape = (hr_height, hr_width, channels)
data_loader = dataLoaderUSR4(DATA_PATH="/content/drive/My Drive/USR-248/", SCALE=2)
...
checkpoint_dir = os.path.join("/content/drive/My Drive/USR/checkpoints/PAL4/", phase)
